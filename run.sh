...
for name in "${client_names[@]}"; do
    ...
    sudo node --trace-warnings src/url_scanner_new.js "$name" "$1" > ./"$name" 2>&1
...
echo "Report for ${current_date}" | s-nail -s "BMS Scanner report ${current_date}" -r "BMS Scanner <desertjones404@gmail.com>" -a src/reports/report_${current_date} moid68580@gmail.com
